    ...
    <section id="servicios" className="py-24 bg-black">
      <div className="container mx-auto px-6">
        <AnimateOnScroll className="text-center mb-16">
          <div className="text-sm font-semibold text-blue-500 uppercase tracking-widest mb-4">Nuestros Servicios</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <AnimateOnScroll key={index} delay={index * 0.1}>
                <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-white/5 group transition-all duration-300 hover:border-blue-600/30 hover:-translate-y-2 cursor-pointer">
